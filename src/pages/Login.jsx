...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError('Invalid credentials. Try admin@jobportal.com / admin123');
        }
    };
        ...
        <div className="min-h-screen">
            ...
            <div className="container flex items-center justify-center py-20">
                <motion.div
                    ...
                    className="glass p-12 rounded-3xl w-full max-w-md shadow-2xl relative overflow-hidden"
                >
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-4xl font-extrabold outfit text-white mb-3">Welcome Back</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button type="submit" className="btn btn-primary w-full py-4 text-xl font-bold shadow-lg mt-4">
                            <LogIn className="w-6 h-6" /> Access Account
                        </button>
                    </form>
